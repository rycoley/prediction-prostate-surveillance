...
### This code is used to summarize posterior estimates and coverage of the joint posterior from the unadjusted (non-IOP) model
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-p_eta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-mu_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-mu_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-sigma_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-sigma_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-cov_int_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-beta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-sigma_res-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/UNADJ/results/jags-prediction-unadj-gamma_RC-",j,".csv") )
