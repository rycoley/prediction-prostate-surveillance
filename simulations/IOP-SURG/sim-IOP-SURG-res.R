...
### This code is used to summarize posterior estimates and coverage of the joint posterior from the surgery IOP model

load("simulations/simulation-data/pars-for-data-sim.RData")


params <- c("p_eta",  "mu_int", "mu_slope", "sigma_int", "sigma_slope", "sigma_res", "cov_int_slope", "beta", "gamma_RC", "omega_SURG")  
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-p_eta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-mu_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-mu_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-sigma_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-sigma_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-cov_int_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-beta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-sigma_res-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-SURG/results/jags-prediction-IOP-SURG-gamma_RC-",j,".csv") )
