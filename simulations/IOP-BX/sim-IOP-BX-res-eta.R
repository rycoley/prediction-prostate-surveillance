...
### This code is used to summarize predictive accuracy of true state predictions from the biopsy IOP model
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/eta-true-vs-pred-IOP-BX-",j,".csv"))
...
save(auc.res=auc.res, mse.res=mse.res, mae.res=mae.res, file="simulations/IOP-BX/results/sim-IOP-BX-res-eta.RData")
