...
# parameters to track
params <- c("eta_hat", "p_eta",  "mu_int", "mu_slope", "sigma_int", "sigma_slope", "sigma_res", "cov_int_slope", "beta", "nu_BX", "gamma_RC")  
...
### RUN JAGS MODEL
outj<-jags(jags_data, inits=inits, parameters.to.save=params, model.file="simulations/IOP-BX/IOP-BX-jags-model.txt", n.thin=nt, n.chains=nc, n.burnin=nb, n.iter=ni)
