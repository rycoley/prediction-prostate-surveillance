...
### This code is used to summarize posterior estimates and coverage of the joint posterior from the biopsy IOP model
...
params <- c("p_eta",  "mu_int", "mu_slope", "sigma_int", "sigma_slope", "sigma_res", "cov_int_slope", "beta", "nu_BX", "gamma_RC")  
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-p_eta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-mu_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-mu_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-sigma_int-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-sigma_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-cov_int_slope-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-beta-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-sigma_res-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-nu_BX-",j,".csv") )
...
for(j in 1:nsims){
	res<-read.csv(paste0("simulations/IOP-BX/results/jags-prediction-IOP-BX-gamma_RC-",j,".csv") )
