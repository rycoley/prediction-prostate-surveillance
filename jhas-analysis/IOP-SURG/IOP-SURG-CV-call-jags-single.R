...
### This code is used to call the JAGS model that allows for a possible surgery informative observation process (IOP) when doing CROSS-VALIDATION for the latent state
...
(to_mask<-c(48, 68, 92, 151, 168, 202)[index])
...
source("jhas-analysis/IOP-SURG/IOP-SURG-CV-prep-data-for-jags.R")
...
write.csv(eta_fitted,paste("jhas-analysis/IOP-SURG/results/eta-fitted-IOP-SURG-",to_mask,".csv",sep=""))
