...
#output files
#$ -o iop-bx-cv-pred-mod.out
#$ -e iop-bx-cv-pred-mod.err
...
#execute command
R CMD BATCH  /home/bst/student/rcoley/inhealth/prediction-model/for-git/jhas-analysis/IOP-BX/IOP-BX-CV-call-jags-single.R iop-bx-cv-pred-mod-s.Rout
