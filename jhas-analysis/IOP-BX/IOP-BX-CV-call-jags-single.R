...
### This code is used to call the JAGS model that allows for a possible biopsy informative observation process (IOP) when doing CROSS-VALIDATION for the latent state
...
(to_mask<-c(32, 47, 124, 137, 170, 181, 192, 202)[index])
...
source("jhas-analysis/IOP-BX/IOP-BX-CV-prep-data-for-jags.R")
...
write.csv(eta_fitted,paste("jhas-analysis/IOP-BX/results/eta-fitted-IOP-BX-",to_mask,".csv",sep=""))
