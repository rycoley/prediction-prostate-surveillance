...
#output files
#$ -o iop-bx-pred-mod.out
#$ -e iop-bx-pred-mod.err
...
#execute command
R CMD BATCH  /home/bst/student/rcoley/inhealth/prediction-model/for-git/jhas-analysis/IOP-BX/IOP-BX-call-jags.R iop-bx-pred-mod.Rout
