...
### This code is used to pull in and format all the data needed to run the jags model that accounts for possible biopsy and surgery informative observation processes (IOP) when doing CROSS-VALIDATION, meaning that some data on observed latent state will be excluded
