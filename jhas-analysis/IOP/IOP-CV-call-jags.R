...
### This code is used to call the JAGS model that allows for possible biopsy and surgery informative observation processes (IOP) when doing CROSS-VALIDATION for the latent state
...
source("jhas-analysis/IOP/IOP-CV-prep-data-for-jags.R")
...
write.csv(eta_fitted,paste("jhas-analysis/IOP/results/eta-fitted-iop-",to_mask,".csv",sep=""))
