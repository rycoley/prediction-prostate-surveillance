...
#output files
#$ -o iop-cv-pred-mod.out
#$ -e iop-cv-pred-mod.err
...
#execute command
R CMD BATCH  /home/bst/student/rcoley/inhealth/prediction-model/for-git/jhas-analysis/IOP/IOP-CV-call-jags.R iop-cv-pred-mod.Rout
